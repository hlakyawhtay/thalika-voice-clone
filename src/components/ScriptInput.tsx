  ...
  return (
    <section className="studio-card-bg rounded-xl border border-studio-border p-5">
      ...
      <textarea
        ...
        className="studio-control-bg min-h-72 w-full resize-y rounded-xl border border-studio-border px-4 py-3 leading-7 text-studio-text outline-none transition placeholder:text-studio-muted/60 focus:border-studio-accent"
      />
